...
import com.example.arafat.dcash.earn.IncomeFactory;
...
public class DCASHMainActivity extends BaseActivity
    ...
    private void initializeView() {
        ...
        tvUserAvailableBalance = headerView.findViewById(R.id.tvUserBalance);
        tvUserEarningBalance = headerView.findViewById(R.id.tvUserEarnBalance);
